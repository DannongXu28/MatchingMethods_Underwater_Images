...
# Helper function to create a convolutional layer with specified parameters
...
# MeanShift layer used for mean normalization
...
# Upsampler block used to increase the resolution of feature maps
...
# Pre-normalization layer used before applying other transformations
...
# Another variant of Pre-normalization with two inputs
...
# Cross-Attention mechanism used in transformers
