...
parser.add_argument("-input_shape",default=[105, 105])
parser.add_argument("-train_own_data",default=True)
parser.add_argument("-pretrained",default=False)
parser.add_argument("-model_path",default="logs/best_epoch_weights_test1.pth")
...
parser.add_argument("-save_period",default=10)
