...
# Define the SiameseDataset class, inheriting from PyTorch's Dataset class
class SiameseDataset(Dataset):
    ...
    def __getitem__(self, index):
        batch_images_path = []
        # ------------------------------------------#
        #   Select three images of the same category
        # ------------------------------------------#
        c               = random.randint(self.start_types, self.types - 1)
        selected_path   = self.train_lines[self.train_labels[:] == c]
        # ------------------------------------------#
        #   Select two similar images
        #   These two images should yield a network output of 1
        # ------------------------------------------#
        ...
        # Ensure selected_path is not empty
    ...
    def _convert_path_list_to_images_and_labels(self, path_list):
        ...
        #-------------------------------------------#
        # Randomly shuffle the pairs and labels
        #-------------------------------------------#
